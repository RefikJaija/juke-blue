    ...
    <div className="max-w-4xl mx-auto px-4 py-16">
      ...
      <div className="prose prose-lg text-antique">
        ...
        <p>
          ...
          und Uhrzeit des Abrufs, die IP-Adresse, die übertragene Datenmenge und
          der anfragende Provider. Die Verarbeitung erfolgt auf Grundlage des Art.
          6 Abs. 1 lit. f DSGVO aus unserem überwiegenden berechtigten Interesse
          an der Gewährleistung eines störungsfreien Betriebs unserer Website
          sowie zur Verbesserung unseres Angebotes.
        </p>
        <p>
          Ihre Daten werden dabei u.a. nach Kanada übermittelt. Für
          Datenübermittlungen nach Kanada liegt ein Angemessenheitsbeschluss der
          EU-Kommission vor.
        </p>
        ...
        <p>
          Kontaktieren Sie uns auf Wunsch. Die Kontaktdaten des für die
        ...
        <p>
          ...
          Daten werden anschließend unter Beachtung gesetzlicher Aufbewahrungsfristen
        ...
        <p>
          ...
          Widerruf erfolgten Verarbeitung berührt wird. Ihr Kundenkonto wird
        ...
        <p>
          ...
          Ihrer Bestellung sowie zur Bearbeitung Ihrer Anfragen erforderlich ist.
          ...
          lit. b DSGVO und ist für die Erfüllung eines Vertrags mit Ihnen
          erforderlich.
        </p>
        <p>
          Eine Weitergabe Ihrer Daten erfolgt dabei beispielsweise an die
          von Ihnen gewählten Versandunternehmen und Dropshipping Anbieter,
        ...
        <p>
          Ihre Daten werden dabei an einen Dienstleister für E-Mail-Marketing im
          Rahmen einer Auftragsverarbeitung weitergegeben. Eine Weitergabe an
          sonstige Dritte erfolgt nicht.
        </p>

        <h2>Zahlungsdienstleister und Bonitätsauskunft</h2>

        <h3>Verwendung von PayPal</h3>
        <p>
          Alle PayPal-Transaktionen unterliegen der PayPal-Datenschutzerklärung. Diese finden Sie unter{" "}
          <a href="https://www.paypal.com/de/webapps/mpp/ua/privacy-full" target="_blank" rel="noopener noreferrer">https://www.paypal.com/de/webapps/mpp/ua/privacy-full</a>
        </p>

        <h3>Verwendung von PayPal Express</h3>
        <p>
          Wir verwenden auf unserer Website den Zahlungsdienst PayPal Express
          der PayPal (Europe) S.à.r.l. et Cie, S.C.A. (22-24 Boulevard Royal L-2449,
          Luxemburg; "PayPal"). Die Datenverarbeitung dient dem Zweck, Ihnen die
          Zahlung über den Zahlungsdienst PayPal Express anbieten zu können. Zur
          Einbindung dieses Zahlungsdienstes ist es erforderlich, dass PayPal beim
          Aufruf der Website Daten (z.B. IP-Adresse, Gerätetyp, Betriebssystem,
          Browsertyp, Standort Ihres Geräts) sammelt, speichert und analysiert.
          Hierzu können auch Cookies eingesetzt werden. Die Cookies ermöglichen
          die Wiedererkennung Ihres Browsers.
        </p>
        <p>
          Die Nutzung von Cookies oder vergleichbarer Technologien erfolgt auf
          Grundlage des § 15 Abs. 3 S. 1 TMG. Die Verarbeitung Ihrer
          ...
          kundenorientierten Angebot von verschiedenen Zahlarten. Sie haben das
          Recht aus Gründen, die sich aus Ihrer besonderen Situation ergeben,
          jederzeit dieser Verarbeitungen Sie betreffender personenbezogener Daten
          zu widersprechen.
        </p>
        <p>
          Mit Auswahl und Nutzung von PayPal Express werden die zur
          ...
          Zahlungsdienstes PayPal Express finden Sie in der dazugehörigen
          Datenschutzerklärung unter{" "}
          <a href="www.paypal.com/de/webapps/mpp/ua/privacy-full?locale.x=de_DE#Updated_PS" target="_blank" rel="noopener noreferrer">www.paypal.com/de/webapps/mpp/ua/privacy-full?locale.x=de_DE#Updated_PS</a>.
        </p>

        <h3>Verwendung von Amazon Payments</h3>
        <p>
          ...
          Luxemburg; “Amazon Payments”).
        </p>
        <p>
          Die Datenverarbeitung dient dem Zweck, Ihnen die Zahlung über den
          Zahlungsdienst Amazon Payments anbieten zu können.
        </p>
        <p>
        ...
        <p>
          ...
          Datenschutzerklärung unter:{" "}
          <a href="https://pay.amazon.com/de/help/201212490" target="_blank" rel="noopener noreferrer">https://pay.amazon.com/de/help/201212490</a>
        </p>

        <h3>Verwendung der personenbezogenen Daten bei Auswahl von Klarna Zahlungsoptionen</h3>
        <p>
          Um Ihnen die Zahlungsoptionen von Klarna anbieten zu können, werden wir
          personenbezogene Daten, wie beispielsweise Kontaktdaten und
          Bestelldaten, an Klarna übermitteln. So kann Klarna beurteilen, ob Sie
          die über Klarna angebotenen Zahlungsoptionen in Anspruch nehmen können
          und die Zahlungsoptionen an Ihre Bedürfnisse anpassen. Allgemeine
          Informationen zu Klarna erhalten Sie unter:{" "}
          <a href="https://www.klarna.com/de/" target="_blank" rel="noopener noreferrer">https://www.klarna.com/de/</a>.
          ...
          Klarnas Datenschutzbestimmungen unter{" "}
          <a href="https://cdn.klarna.com/1.0/shared/content/legal/terms/0/de_de/privacy" target="_blank" rel="noopener noreferrer">https://cdn.klarna.com/1.0/shared/content/legal/terms/0/de_de/privacy</a>
          behandelt.
        </p>
        ...
        <p>
          ...
          Computersystem eines Nutzers gespeichert werden. Ruft ein Nutzer eine
        ...
        <p>
          ...
          die volle Kontrolle über die Verwendung von Cookies. Durch die Auswahl
          entsprechender technischer Einstellungen in Ihrem Internetbrowser können
          Sie vor dem Setzen von Cookies benachrichtigt werden und über die
          Annahme einzeln entscheiden sowie die Speicherung der Cookies und
        ...
        <ul>
          ...
          <li>Safari: <a href="https://support.apple.com/de-de/guide/safari/manage-cookies-and-website-data-sfri11471/mac" target="_blank" rel="noopener noreferrer">https://support.apple.com/de-de/guide/safari/manage-cookies-and-website-data-sfri11471/mac</a></li>
        </ul>

        <h3>Technisch notwendige Cookies</h3>
        <p>
          Soweit nachstehend in der Datenschutzerklärung keine anderen
        ...
        <p>
          ...
          erfolgt auf Grundlage des § 15 Abs. 3 S. 1 TMG. Die Verarbeitung Ihrer
          personenbezogenen Daten erfolgt auf Grundlage des Art. 6 Abs. 1 lit. f
          ...
          nutzerfreundlichen und effektiven Gestaltung unseres Angebots.
          Sie haben das Recht aus Gründen, die sich aus
          Ihrer besonderen Situation ergeben, jederzeit dieser Verarbeitungen Sie
          betreffender personenbezogener Daten zu widersprechen.
        </p>

        <h3>Verwendung von GDPR Legal Cookie</h3>
        <p>
          Wir verwenden auf unserer Website das Consent-Management-Tool GDPR Legal
          Cookie der beeclever GmbH (Universitätsstraße 3, 56070 Koblenz a. Rh.;
          „beeclever“). Das Tool ermöglicht es Ihnen, Einwilligungen in
          Datenverarbeitungen über die Website, insbesondere das Setzen von
          Cookies, zu erteilen sowie von Ihrem Widerrufsrecht für bereits erteilte
          Einwilligungen Gebrauch zu machen.
        </p>
        <p>
          ...
          gesetzliche Verpflichtungen einzuhalten. Hierzu können Cookies eingesetzt
          werden. Dabei können u. a. folgende Informationen erhoben und an
          Cookiebot übermittelt werden: anonymisierte IP-Adresse, Datum und
          Uhrzeit der Zustimmung, URL, von der die Zustimmung gesendet wurde,
          anonymer, zufälliger, verschlüsselter Key, Einwilligungsstatus. Eine
          Weitergabe dieser Daten an sonstige Dritte erfolgt nicht.
        </p>
        <p>
          Die Datenverarbeitung erfolgt zur Erfüllung einer rechtlichen
          ...
          finden Sie unter:{" "}
          <a href="https://gdpr-legal-cookie.com/pages/terms-conditions" target="_blank" rel="noopener noreferrer">https://gdpr-legal-cookie.com/pages/terms-conditions</a>{" "}
          sowie unter{" "}
          <a href="https://gdpr-legal-cookie.com/pages/datenschutzerklarung" target="_blank" rel="noopener noreferrer">https://gdpr-legal-cookie.com/pages/datenschutzerklarung</a>.
        </p>
        ...
        <p>
          ...
          „Google“). Soweit Sie Ihren gewöhnlichen Aufenthalt im Europäischen
        ...
        <p>
          ...
          und ihrer Besucher sowie für Marketing- und Werbezwecke. Dazu wird
          ...
          Dienstleistungen gegenüber dem Websitebetreiber zu erbringen. Dabei
          können u.a. folgende Informationen erhoben werden: IP-Adresse, Datum und
          Uhrzeit des Seitenaufrufs, Klickpfad, Informationen über den von Ihnen
        ...
        <p>
          ...
          unter{" "}
          <a href="https://www.google.com/analytics/terms/de.html" target="_blank" rel="noopener noreferrer">https://www.google.com/analytics/terms/de.html</a>{" "}
          bzw. unter{" "}
          <a href="https://www.google.de/intl/de/policies/" target="_blank" rel="noopener noreferrer">https://www.google.de/intl/de/policies/</a>{" "}
          sowie unter{" "}
          <a href="https://policies.google.com/technologies/cookies?hl=de" target="_blank" rel="noopener noreferrer">https://policies.google.com/technologies/cookies?hl=de</a>.
        </p>
