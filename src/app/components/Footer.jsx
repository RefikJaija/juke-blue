...
//                   className="px-6 py-2 bg-blush text-white rounded-lg hover:bg-blush-dark transition-colors"
//                 >
...
//               {/* Spirits forged by the sea's journey. */}
//             </p>
//           </div>
...
//                {/* Bandcamp */}
//                 <a href="https://bandcamp.com" target="_blank" rel="noopener noreferrer" className="hover:text-blush transition-colors">
...
export default function Footer() {
  ...
  return (
    <footer className="bg-nautical text-antique relative mt-20 border-t border-antique"> {/* Added border-t border-antique */}
